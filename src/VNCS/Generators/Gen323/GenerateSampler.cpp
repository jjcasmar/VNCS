...
VNCS::Sampler<VNCS::Space3D> VNCS::Generators::Gen323::GenerateSampler::operator()(
    ...
    const VNCS::Space3D::TetraMesh &coarseMesh)
{
    ...
    const auto vIndices = coarseMesh.tetras[samplerDefinition.baseFace];
    ...
    sampler.a = 1.0;
    sampler.coarseFaceIdx = samplerDefinition.baseFace;
...
VNCS::Sampler<VNCS::Space2D> VNCS::Generators::Gen323::GenerateSampler::operator()(
