...
#include <VNCS/Generators/Gen223/GenerateSampler.h>
...
void VNCS::Generators::Gen223::SamplingPointsExporter::operator()(const VNCS::Space3D::Mesh &coarseMesh,
...
std::filesystem::path VNCS::Generators::Gen223::SamplingPointsExporter::coarseSamplersFilePath() const
{
    return m_coarseSamplersFilePath;
}

void VNCS::Generators::Gen223::SamplingPointsExporter::setCoarseSamplersFilePath(
    const std::filesystem::path &coarseSamplersFilePath)
{
    m_coarseSamplersFilePath = coarseSamplersFilePath;
}

std::filesystem::path VNCS::Generators::Gen223::SamplingPointsExporter::fineSamplersFilePath() const
{
    return m_fineSamplersFilePath;
}

void VNCS::Generators::Gen223::SamplingPointsExporter::setFineSamplersFilePath(
